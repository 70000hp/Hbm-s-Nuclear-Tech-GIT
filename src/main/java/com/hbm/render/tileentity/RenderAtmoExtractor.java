...
public class RenderAtmoExtractor extends TileEntitySpecialRenderer implements IItemRendererProvider {
	...
	public Item getItemForRenderer() {
		return Item.getItemFromBlock(ModBlocks.machine_atmo_vent);
	}
