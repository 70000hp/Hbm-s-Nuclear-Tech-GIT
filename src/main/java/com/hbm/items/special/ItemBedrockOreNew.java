...
public class ItemBedrockOreNew extends Item {
	...
	public static enum BedrockOreType {
		...
		**/
		//												primary									sulfuric															solvent																		radsolvent
		LIGHT_METAL(	0xFFFFFF, 0x353535, "light",	o(MAT_IRON, 9),		o(MAT_COPPER, 9),	o(MAT_TITANIUM, 9),	o(MAT_ALUMINIUM, 5),	o(MAT_ALUMINIUM, 4),	o(MAT_TITANIUM, 5),	o(MAT_LITHIUM, 5),		o(MAT_SODIUM, 3),		o(MAT_CADMIUM, 6),	o(MAT_LITHIUM, 6),		o(MAT_SODIUM, 6)),
		HEAVY_METAL(	0x868686, 0x000000, "heavy",	o(MAT_TUNGSTEN, 9),	o(MAT_LEAD, 9),		o(MAT_GOLD, 2),		o(MAT_GOLD, 2),			o(MAT_BERYLLIUM, 3),	o(MAT_TUNGSTEN, 9),			o(MAT_LEAD, 9),			o(MAT_GOLD, 5),			o(MAT_TANTALIUM, 1),			o(MAT_BISMUTH, 1),		o(MAT_GOLD, 6)),
