...
public class GUIFurnaceCombo extends GuiInfoContainer {
	...
	public void drawScreen(int x, int y, float interp) {
		...
		furnace.input.renderTankInfo(this, x, y, guiLeft + 21, guiTop + 17, 16, 52);
		furnace.output.renderTankInfo(this, x, y, guiLeft + 132, guiTop + 17, 16, 52);

		this.drawCustomInfoStat(x, y, guiLeft + 60, guiTop + 28, 39, 7, x, y, new String[] { String.format(Locale.US, "%,d", furnace.progress) + " / " + String.format(Locale.US, "%,d", furnace.processTime) + "TU" });
		this.drawCustomInfoStat(x, y, guiLeft + 60, guiTop + 37, 39, 7, x, y, new String[] { String.format(Locale.US, "%,d", furnace.heat) + " / " + String.format(Locale.US, "%,d", furnace.maxHeat) + "TU" });
	}
