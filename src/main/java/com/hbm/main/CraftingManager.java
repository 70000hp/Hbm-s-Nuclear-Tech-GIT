...
public class CraftingManager {
	...
	public static void reg2() {
		...
		if(!GeneralConfig.enable528) {
			...
			addRecipeAuto(new ItemStack(ModBlocks.struct_launcher_core_large, 1), new Object[] { "SIS", "ISI", "BEB", 'S', DictFrame.fromOne(ModItems.circuit, EnumCircuitType.ADVANCED), 'I', Blocks.iron_bars,'B', ModBlocks.struct_launcher, 'E', ModBlocks.machine_battery });
